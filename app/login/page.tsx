...
export default function LoginPage() {
  ...
  async function handleLogin(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      /*
       * The middleware performs the final ADMIN_EMAIL
       * authorization check.
       *
       * We deliberately do not trust the browser to
       * decide whether this user is an administrator.
       */
    ...
    <main className="min-h-screen bg-[#f5f8fa] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        >
          <div className="mb-7">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-500">
              Sign in to manage revenue recovery assessments, leads and customer
              activity.
            </p>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Cleavon Digital · Revenue Recovery Systems
        </p>
      </div>
    </main>
  );
